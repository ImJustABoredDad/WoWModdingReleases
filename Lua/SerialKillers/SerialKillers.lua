...
local function UpdateKillData()
    ...
    if (results) then
        ...
        PrintError("[SerialKillers] Error fetching data from database.")
    end
end
...
local function OnGossipHello(event, player, object)
    ...
    for i, data in ipairs(killData) do
        player:GossipMenuAddItem(0, "|TInterface/Icons/Ability_BackStab:24:24:-21:0|t" .. i .. ". " .. data.name .. " - " .. data.kills .. " kills", 0, 0)
    end
