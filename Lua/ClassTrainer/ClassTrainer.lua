...
-- This is the main config if you don't know what your doing I recommend not changing anything other than these.
local config = {
    creatureId = 100002,
...
local function OnGossipHello(event, player, object)
    ...
    player:GossipMenuAddItem(0, "|TInterface/Icons/INV_Offhand_Sunwell_D_01:24:24:-21:0|tLearn Class Spells", 0, 1)
    player:GossipMenuAddItem(0, "|TInterface/Icons/Spell_Shadow_SoulLeech_1:24:24:-21:0|tReset Talents", 0, 2)
    player:GossipMenuAddItem(0, "|TInterface/Icons/Spell_Shadow_SacrificialShield:24:24:-21:0|tNevermind", 0, 3)
...
local function OnGossipSelect(event, player, object, sender, intid, code)
    ...
    elseif (intid == 2) then
        player:ResetTalents()
        player:SendBroadcastMessage(config.prefix .. "|TInterface/Icons/Spell_Shadow_SoulLeech_1:16:16:0:-1|t|cff60a9e4[Trainer]|cffffffff Your talents have been reset.")
    end
